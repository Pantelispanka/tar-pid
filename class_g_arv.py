...
for index, row in train.iterrows():
    # print(row[source_docked_confs_class].mean())
...
class GATConv_V1_MULTI(torch.nn.Module):
    ...
    def __init__(self, in_channels
        ...
        self.out = torch.nn.Linear(hidden_channels, 224)
        self.out1 = torch.nn.Linear(224, out_channels)
        self.sigmoid = torch.nn.Sigmoid()
...
model = GATConv_V1_MULTI(33, 6, 80, outs_num, act_first=True)
